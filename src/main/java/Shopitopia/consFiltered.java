...
public class consFiltered {

    public static void main(String[] args) {
        Logger logger = LoggerFactory.getLogger(consFiltered.class.getName());
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "filtered");
        ...
        while(true) {
            ...
            for (ConsumerRecord<String,String> record : records) {
                ...
                String customer = message.get("customer").toString();
                if(customer.contains("Judy Hopps\uD83D\uDC30")) {
